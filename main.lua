...
-- Created on: Feb.26th/2019
-- 
-- This file is the program for Assignment 2:
-----------------------------------------------------------------------------------------
...
local calculateButton = display.newImageRect( "Assets/calculate-button-hi.png", 106, 120 )
calculateButton.x = display.contentCenterX
calculateButton.y = 250
calculateButton.id = "calculate button"

local Circle = display.newImageRect( "Assets/circle.png", 100, 100 )
Circle.x = 150
Circle.y = 120
